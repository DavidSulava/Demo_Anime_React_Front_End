    ...
    getState()
        {
            ...
            let SubComponent = this.props.search && this.props.search.data &&  this.props.search.data[0]._id ? (
                        ...
                        <div  className="search-suggest row  col-xs-11 col-md-offset-8 col-md-3 " style={{display: 'block'}}>
    ...
    render()
        {
            return (
                  <div>
                    ...
                    <div className="search-content col-xs-4 col-sm-7 col-md-2">
                        ...
                        <div className="inputCont">
                            ...
                            <input onFocus={ ()=>this.showResults() } onBlur={ ()=>this.hideResults() } onChange ={ (e)=> this.makeReq(e) }   name="keyword" type="text" className="form-control search-input  col-md-3 " placeholder="Type to search..."/>
                    ...
                    <div  className="wrapper_MbSearch row  col-xs-12" style={{display: 'none'}}>
