...
export class Profile extends Component {
    ...
    emailConfirm = ( ev )=>{
      ...
      var path = '/user/email/sendVerification';
      ...
      return (
        <div>
          ...
          <div className="passChange">
            ...
            <form method="POST" onSubmit={ (ev)=> this.updateUser(ev, '/user/newPassword') } action='/users/newPassword' className="profile_forms">
                <br/>
          ...
          <div className="deleteAccount">
            ...
            <form onSubmit={ (ev)=> this.updateUser(ev, '/user/deleteUser') } method="POST" action='/users/deleteUser' className="profile_forms">
...
const mapDispatchToProps = ( dispatch )=>{
    return {
      updateUser   : ( path, params) => {  dispatch( updateUserData( path, params ) ) },
