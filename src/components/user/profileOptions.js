      ...
      <div>
        {/* ---------------[ Verify Email ]----------- */}
        {
          ...
          <div className="avatarWrapperWrapper">
            ...
            <br/>
            <button
              onClick={(ev) => this.emailConfirm(ev)}
              type="submit"
        ...
        <div className="avatarWrapperWrapper">
          ...
          <br/>
          <button
            onClick={(ev) => this.showImgEl(ev)} type="submit"
            className="submit_profile btn btn-success btn-sm"
          >
            Select
          </button>
        ...
        <div
          onClick={(ev) => this.showImgEl(ev, false)}
        ...
        >
          <div onClick={(ev) => this.showImgEl(ev)} className="avatarIMG_canvas_wrapper">
            ...
            <div className="close_cropper_wrapper">
              <a onClick={(ev) => this.showImgEl(ev, false)} className="close_cropper"
            ...
            <div className='img_sel_holder'>
              {
                images.map(function (el, index) {
                  ...
                  return (
                    <img
                      onClick={(ev) => this.imgSel(ev)} src={imgPath + el}
                      key={index}
                      style={imgStyle} alt=""
                      height="72" width="72"
                    ></img>
        ...
        <div className="profWrapper">
          ...
          <form
            onSubmit={(ev) => this.updateUser(ev)}
            method="POST"
          ...
          >
            ...
            <input
              ...
              onChange={this.valueChanged}
              defaultValue={this.props.user.email} placeholder={this.props.user.email}
            />
            ...
            <input
              type="text" name='firstName' className="firstName"
              onChange={this.valueChanged}
              defaultValue={this.props.user.firstName} placeholder={this.props.user.firstName}
            />
            ...
            <input
              ...
              onChange={this.valueChanged}
              defaultValue={this.props.user.lastName} placeholder={this.props.user.lastName}
            />

            <br/>
            <label htmlFor="">Phone Number</label><br/>
            <input
              type="text" name='phone' className="phone"
              onChange={this.valueChanged}
              defaultValue={this.props.user.phone} placeholder={this.props.user.phone}
            />

            <br/><br/>
            <button
              type="submit" name="submit_profile_change btn btn-success btn-sm"
        ...
        <div className="passChange">
          ...
          >
            ...
            <input type="password" name='new_password' className="password" placeholder='New Password'/>
...

            {
              ...
              <label className='success alert alert-success'>{this.state.msg.passChanged}</label>
            }
            <br/> <br/>
            <button type="submit" name="submitPassChange" className="submit_profile btn btn-success btn-sm">Change
            </button>
          </form>
        </div>
